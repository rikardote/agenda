...
@foreach($citas as $cita)
	...
	<table cellspacing="0" border="0">
		...
		<tr>
			...
			<td style="border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=bottom bgcolor="#FFFFFF"><b><font color="#000000">{{$cit->paciente->rfc}} /{{$cit->paciente->tipo->code}}</font></b></td>
			...
			<td style="border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=bottom bgcolor="#FFFFFF"><b><font color="#000000">
			@if ($cit->paciente->gender == 'F')
				{{getEdad($cit->paciente->fecha_nacimiento)}}
			@endif
			<br></font></b></td>
			<td style="border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=bottom bgcolor="#FFFFFF" sdval="35" sdnum="1033;"><b><font color="#000000">
